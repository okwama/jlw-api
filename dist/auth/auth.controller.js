...
let AuthController = class AuthController {
    ...
    async login(loginData) {
        try {
            const user = await this.authService.login(loginData.emailOrPhone, loginData.password);
            return {
                success: true,
    ...
    async changePassword(id, passwordData) {
        try {
            const success = await this.authService.changePassword(parseInt(id), passwordData.newPassword);
            if (success) {
                return {
                    success: true,
